...
function generateFlightNo(airline) {
    ...
    // Format: digit + capital letter + space + 4 digits
    return `${prefixes[airline]} ${String(Math.floor(1000 + Math.random() * 9000))}`;
}
...
async function loadSampleFlights() {
    try {
        ...
        // Generate dates starting from tomorrow for next 3 months
